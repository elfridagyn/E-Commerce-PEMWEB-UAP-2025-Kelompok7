...
<head>
    ...
    <title>Kelola Produk - Seller</title>
    ...
    <style>
        ...
        .user-info {
            ...
            backdrop-filter: blur(10px);
            position: relative;
            color: #6b2b38; /* Menambahkan warna teks agar terbaca */
            font-weight: 600;
            box-shadow: 0px 4px 12px rgba(0,0,0,0.15);
        }
        ...
        .avatar {
            ...
            border-radius: 50%;
            object-fit: cover;
            background: #f3e5e8; /* Background fallback untuk avatar */
...
<div class="container">
    ...
    <div class="title-box">
        ...
        <h2>Kelola Produk</h2>
        <p>Tambah, ubah, atau hapus produk toko Anda.</p>
    </div>

    <a href="{{ route('seller.products.create') }}" class="btn-add"><i class="fas fa-plus"></i> Tambah Produk</a>
    ...
    <div class="table-box">
        <table>
            ...
            <tr>
                ...
                <td>{{ $product->stock }}</td>
                <td>
                    <a href="{{ route('seller.products.edit', $product->id) }}" class="btn btn-edit"><i class="fas fa-edit"></i> Edit</a>
                    <form action="{{ route('seller.products.destroy', $product->id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-delete" onclick="return confirm('Hapus produk ini?')">
